...
import br.com.luciano.popularmovies.api.MovieReviewsResponse;
import br.com.luciano.popularmovies.api.MovieVideosResponse;
...
public class MovieDetailFragment extends RxFragment {
    ...
    private void initViews() {
        ...
        String releaseDate = String.format(getString(br.com.luciano.popularmovies.R.string.movie_detail_release_date),
